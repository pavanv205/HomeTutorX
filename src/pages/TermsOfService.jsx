      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 space-y-12">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl p-6 md:p-10 space-y-10 shadow-sm">
          ...
          <div className="space-y-3.5">
            ...
            <ul className="list-disc pl-5 text-sm text-slate-600 dark:text-slate-400 space-y-2 font-medium">
              <li><strong>Student Verification Fee:</strong> Students pay a one-time profile verification fee of ₹5 upon registration to activate their account and request classes.</li>
              <li><strong>Tutor Subscription Plan:</strong> Tutors pay ₹5 to register for a 5 minuties subscription plan. The subscription must be renewed every 5 minuties to maintain dashboard access and profile listing visibility.</li>
